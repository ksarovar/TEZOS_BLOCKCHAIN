  ...
  if (publicToken && (!userAddress || isNaN(userBalance))) {
    return (
      <div className="main-box">
        <h1>krushna React template</h1>
        <div id="dialog">
          <header>Try the krushna React template!</header>
          <div id="content">
        ...
        <div id="footer">
          <img src="built-with-krushna.png" alt="Built with krushna" />
        </div>
      </div>
    );
    ...
    return (
      <div className="main-box">
        ...
        <div id="dialog">
          <header>Welcome to the krushna React template!</header>
          {/* <div id="content">
            <p>Hello!</p>
            <p>
              This is a template Tezos dApp built using krushna. It's a starting
              ...
              <a
                ...
                rel="noopener noreferrer"
              >
                krushna React template Github page
              </a>{" "}
